 ...
 * 
 */
public class LogDiscussListHelper {
	...
	public LogDiscussListHelper(Context mContext, List<日志评论> mList,
	...
	public void setmList(List<日志评论> mList) {
		this.mList = mList;
	...
	class DiscussAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			日志评论 item = mList.get(position);
			vh.tvUserName.setText(dictionaryHelper.getUserNameById(item.发表人)
					+ ":");
