...
/** 已废弃，采用Fragment的形式 */
@Deprecated
public class WorkLogWeekInfoActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.work_log_week_info);
		findviews();
		setonclicklistener();
		init();
	}
	...
	private void findviews() {
		...
		rlPublishDiscuss = (RelativeLayout) findViewById(R.id.rl_publich_discuss_log_info_week);
		btnPublishDiscuss = (Button) findViewById(R.id.btn_publich_discuss_log_info_week);
		etDiscussContent = (EditText) findViewById(R.id.et_discuss_content_log_info_week);
		rlDiscussContent = (LinearLayout) findViewById(R.id.rl_discuss_content_info_log_week);
		lvDiscuss = (ListView) findViewById(R.id.lv_discuss_log_week);
		ivQuitDiscuss = (ImageView) findViewById(R.id.iv_discuss_quit_log_info_week);// 退出评论
		ivPublishDiscuss = (ImageView) findViewById(R.id.iv_discuss_submit_log_info_week); // 发表评论
		llDiscuss = (LinearLayout) findViewById(R.id.ll_discuss_log_week);
		etDiscuss = (EditText) findViewById(R.id.et_work_log_discuss_week);
		etDiscuss.setFocusable(false);
		btnDiscussCount = (Button) findViewById(R.id.btn_work_log_discuss_week);
	}
		...
		ivPublishDiscuss.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!TextUtils.isEmpty(content)) {
					...
					Toast.makeText(WorkLogWeekInfoActivity.this, "评论内容不能为空",
	...
	private void addHeader() {
		...
		tvHeader.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(WorkLogWeekInfoActivity.this,
