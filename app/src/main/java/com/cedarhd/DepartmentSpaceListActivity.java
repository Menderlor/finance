...
import com.cedarhd.adapter.DepartmentSpaceListViewAdapter;
 ...
 * @author py 2014.8.25
 */
public class DepartmentSpaceListActivity extends BaseActivity {
	...
	private DepartmentSpaceListViewAdapter mListAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.departmentspacelist);
		findviews();
		setonclicklistener();
		...
		mListAdapter = new DepartmentSpaceListViewAdapter(
				DepartmentSpaceListActivity.this,
				R.layout.companyspacelist_listviewlayout, m帖子List, null);
		mListView.setAdapter(mListAdapter);
		mListViewHelperKjx = new ListViewHelperKjx(this, 帖子.class,
				DepartmentSpaceListActivity.this, demand, queryDemand,
				mListView, m帖子List, mListAdapter, mProgressBar);
		reload();
	}
	...
	private void findviews() {
		...
		mProgressBar = (MyProgressBar) findViewById(R.id.progress_departmentspacelist);
	...
	private void setonclicklistener() {
		...
		ivnew.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(DepartmentSpaceListActivity.this,
						DepartmentSpaceNewActivity.class);
