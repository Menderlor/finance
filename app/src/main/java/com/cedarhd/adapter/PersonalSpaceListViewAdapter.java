...
public class PersonalSpaceListViewAdapter<HandlerNewContact> extends BaseAdapter {
	...
	public PersonalSpaceListViewAdapter(Context pContext, int listviewlayoutId,
	...
	public View getView(int position, View view, ViewGroup arg2) {
		...
		if (view == null  || (holder = (ViewHolder) view.getTag()) == null) {
			...
			holder.avartarView = (AvartarView) view
					.findViewById(R.id.avatar_personalspacelist);
