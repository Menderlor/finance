...
public class User_Select_LetterListViewAdapter_zmy extends BaseAdapter {
	 ...
	 * @param listener
	 */
	public User_Select_LetterListViewAdapter_zmy(Context pContext,
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if (view == null || view.getTag() == null) {
			...
			holder.Name = (TextView) view
					.findViewById(R.id.name_userSelect_zmy);
			holder.imageView1 = (ImageView) view
					.findViewById(R.id.imageView1_userSelect_zmy);
			holder.ivPhoto = (ImageView) view
					.findViewById(R.id.iv_photo_userSelect_zmy);
			view.setTag(holder);
		}
		...
		if (item.IsChecked) {
			...
			holder.imageView1.setImageResource(R.drawable.flag_ok);
			// view.setBackgroundResource(R.color.mail_unread_bg);
		} else {
			holder.imageView1.setImageResource(R.drawable.flag_no);
