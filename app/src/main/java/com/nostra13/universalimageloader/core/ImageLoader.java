...
public class ImageLoader {
	 ...
	 */
	public void displayImage(String uri, ImageAware imageAware, String passport) {
		displayImage(uri, imageAware, null, null, null, passport);
	}
	...
	public void displayImage(String uri, ImageAware imageAware,
			ImageLoadingListener listener, String passport) {
		displayImage(uri, imageAware, null, listener, null, passport);
	}
	 ...
	 */
	public void displayImage(String uri, ImageAware imageAware,
			DisplayImageOptions options, String passport) {
		displayImage(uri, imageAware, options, null, null, passport);
	}
	...
	public void displayImage(String uri, ImageAware imageAware,
			...
			String passport) {
		displayImage(uri, imageAware, options, listener, null, passport);
	}
	...
	public void displayImage(String uri, ImageAware imageAware,
			DisplayImageOptions options, ImageLoadingListener listener,
			ImageLoadingProgressListener progressListener, String passport) {
		displayImage(uri, imageAware, options, null, listener,
				progressListener, passport);
	}
	 ...
	 */
	public void displayImage(String uri, ImageAware imageAware,
			DisplayImageOptions options, ImageSize targetSize,
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			ImageLoadingInfo imageLoadingInfo = new ImageLoadingInfo(uri,
					...
					progressListener, engine.getLockForUri(uri), passport);
	 ...
	 */
	public void displayImage(String uri, ImageView imageView, String passport) {
	...
	public void displayImage(String uri, ImageView imageView,
			ImageSize targetImageSize, String passport) {
	...
	public void displayImage(String uri, ImageView imageView,
			DisplayImageOptions options, ImageLoadingListener listener,
			String passport) {
		displayImage(uri, imageView, options, listener, null, passport);
	}
