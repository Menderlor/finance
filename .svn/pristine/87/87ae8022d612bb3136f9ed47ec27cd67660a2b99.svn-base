 ...
 * 
 */
public class TaskDiscussActivity extends BaseActivity {
	...
	private 任务 item;
	public static final String TAG = "TasktDiscussActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (discussListHelper == null) {
			discussListHelper = new DiscussListHelper(TaskDiscussActivity.this,
		...
		new Thread(new Runnable() {
			@Override
			public void run() {
				// zlServiceHelper.getTaskDiscuss(item.getId() + "", handler);
			}
		}).start();
	}
	...
	private void findviews() {
		...
		context = TaskDiscussActivity.this;
