...
public class ClientConstactContentActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		content = bundle.getString(ClientConstactInfoActivity.TAG);
		LogUtils.i("pytestcontent", content);
		findviews();
		setonclicklistener();
	}
	...
	private void findviews() {
		...
		context = ClientConstactContentActivity.this;
	}
		...
		speek.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				new SpeechDialogHelper(context,
						ClientConstactContentActivity.this, etContent, true);
			}
		});
