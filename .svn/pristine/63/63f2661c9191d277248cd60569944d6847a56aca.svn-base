...
public class ORMDataHelper extends OrmLiteSqliteOpenHelper {
	...
	private Dao<Client, Integer> clientDao;// User的Dao
	...
	public void onCreate(SQLiteDatabase db, ConnectionSource connectionSource) {
		try {
			...
			TableUtils.createTable(connectionSource, 部门.class);
			...
			// TableUtils.createTable(connectionSource, 测量信息.class);
			TableUtils.createTable(connectionSource, 流程分类表.class);
			...
			TableUtils.createTable(connectionSource, Rad产品字典.class);
			TableUtils.createTable(connectionSource, Slt产品字典.class);

			TableUtils.createTable(connectionSource, AlarmTask.class);
		} catch (SQLException e) {
			LogUtils.e(ORMDataHelper.class.getName(), "创建数据库失败" + e);
			e.printStackTrace();
	...
	public void onUpgrade(SQLiteDatabase db, ConnectionSource connectionSource,
		...
		try {
			...
			LogUtils.e(ORMDataHelper.class.getName(), "更新数据库失败" + e);
			e.printStackTrace();
		} catch (java.sql.SQLException e) {
			e.printStackTrace();
		}
