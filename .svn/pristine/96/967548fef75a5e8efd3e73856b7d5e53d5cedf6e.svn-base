...
public class RoundProgressBar extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		int colors1 = Color.argb(0xff, 50, 189, 49);
		paint.setColor(colors1);
		...
		if (textIsDisplayable && style == STROKE) {
			...
			canvas.drawText(progress + "", centre - textWidth / 2, centre
					+ textSize / 2, paint); // 画出进度
			int colorss = Color.argb(0xff, 135, 135, 135);
			paint.setColor(colorss);
			canvas.drawText(" /" + max, centre - textWidth1 / 3, centre
					+ textSize / 2, paint); // 画出进度最大值
		}
